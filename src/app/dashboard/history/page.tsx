...
const HISTORY_KEY = 'Инструменты для автоматизации счетов_history';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs mt-0.5" style={{ color: '#edf2f740' }}>
              {items.length} Автоматизированная система выставления счетов с интеграцией для фрилансеров и малых бизнесов.s total
            </p>
          </div>
        </div>
        <Link
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-dashed p-10 text-center" style={{ borderColor: '#5a67d820' }}>
          ...
          <p className="text-sm" style={{ color: '#edf2f750' }}>
            {search || filterStatus !== 'all' ? 'No matching items found' : 'No Автоматизированная система выставления счетов с интеграцией для фрилансеров и малых бизнесов.s yet'}
          </p>
        </div>
      ) : (
